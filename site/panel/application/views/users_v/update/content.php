			...
			<div class="col-md-6">
				<div class="widget">
					...
					<div class="widget-body">
						<form action="<?php echo base_url("kullanicilar/update/$items->id"); ?>" method="POST">
							...
							<button type="submit" name="kullaniciKaydetButton" class="btn btn-primary btn-md">Düzenle</button>
